...
contract ETCTWhitelisted is Context, Ownable {
...
contract TestnetETCT is ERC20, ETCTWhitelisted {
  ...
  ) ERC20(name, symbol) ETCTWhitelisted(time, startTime, blockSellTime) {
